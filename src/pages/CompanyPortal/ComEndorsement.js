    ...
    return (
        <>
            ...
            <Stack sx={{ mt: 2 }} direction="column" justifyContent="flex-start" alignItems="flex-start" spacing={2}>
                ...
                <FormGroup>
                    <FormControlLabel control={<Checkbox />} label="Policy number" />
                    ...
                    <FormControlLabel control={<Checkbox />} label="Directors" />
                    <FormControlLabel control={<Checkbox />} label="PAN number" />
                    <FormControlLabel control={<Checkbox />} label="GST IN" />
                    <FormControlLabel control={<Checkbox />} label="TIN" />
                    <FormControlLabel control={<Checkbox />} label="Directors" />
                </FormGroup>
